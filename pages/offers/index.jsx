  ...
  return (
    <div className={styles.offerCard}>
      ...
      <div className={styles.offerCard__content}>
        <div className={styles.offerCard__content__title}> {offerTitle} </div>
        <div className={styles.offerCard__content__couponCode}> {couponCode} </div>
        <div className={styles.offerCard__content__offerPeriod}> {offerPeriod} </div>
        <div className={styles.offerCard__content__termsAndConditions}>
          <ul className="">
...
const Index = () => {
  ...
  return (
    <div className={styles.__offersContainer}>
      <div className={styles.__offersContainer__heading}>
        <h2>Trazift Offers</h2>
      </div>
      <hr />
      <ul className={styles.__offersContainer__cards}>
        {data.map((item, i) => (
          <li key={i}>
            <OfferCard
              img={item.img}
