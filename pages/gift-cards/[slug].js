...
//   value: PropTypes.any,
// };
// // { gift_card, gift_cardDetail, error, sku }
// const Index = () => {
...
//   useEffect(() => {
//     const fetchGiftCardDetail = async () => {
//       try {
//         const { query } = router;
//         const { slug } = query;
//         console.log("slug", slug);
//         const giftCard = await getGiftCardById(slug);
//         console.log("giftCard", giftCard);
//         setGift_card(giftCard);
//         const sku = giftCard?.sku;
//         try {
//           const giftCardDetail = await getGiftCardDetail(sku);
//           console.log("giftCardDetail", giftCardDetail);
//           const GCDetails = giftCardDetail?.GCDetails;
//           setGift_cardDetail(GCDetails);
//         } catch (error) {
//           console.error("Error fetching getGiftCardDetail:", error);
//         }
//       } catch (error) {
...
//     }
//   };
//   const metaInformation = gift_card?.metaInformation;
//   return (
//     <>
//       <Head>
